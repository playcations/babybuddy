# Generated by Django 5.1.11 on 2025-07-14 00:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name="settings",
            name="medicine_card_hide_threshold",
            field=models.DurationField(
                blank=True,
                choices=[
                    (None, "never hide"),
                    (datetime.timedelta(seconds=3600), "1 hour"),
                    (datetime.timedelta(seconds=21600), "6 hours"),
                ...
                help_text='This setting controls when the "Last Medicine" dashboard card will be hidden after the last medicine entry.',
                null=True,
                verbose_name="Hide medicine card after",
            ),
        ),
